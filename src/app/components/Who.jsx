...
export default function Who() {
  return (
    <div className="bg-[#f0f0f0] text-black py-16 flex flex-col justify-center" id='who'>
        ...
        <h2 className='text-center text-3xl py-10 px-16 lg:text-5xl font-semibold lg:px-80'>We&apos;re a remote tribe of creatives, transforming startups into digital wonders, one project at a time</h2>
