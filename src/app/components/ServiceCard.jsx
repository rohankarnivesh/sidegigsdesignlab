  ...
  return (
      <div className='grid justify-center text-[#f0f0f0] font-medium'>
          ...
          <div className=' cursor-pointer'>
              <h2 className='px-10 bg-gradient-to-r from-neutral-900 via-neutral-800 to-neutral-700 hover:bg-gradient-to-r hover:from-[#CEF62E] hover:to-[#CEF62E] transition-all ease-in-out hover:text-black border rounded-lg text-lg py-2 mt-4'>
                {demo}
