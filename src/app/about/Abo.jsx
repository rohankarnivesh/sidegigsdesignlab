...
export default function Abo() {
  return (
    <div className='px-10 md:px-24 grid lg:grid-cols-2 bg-[#f0f0f0] text-[#131313] pt-10 text-center 2xl:px-96'>
          <div className='flex flex-col md:px-2 leading-loose'>
              <h3 className='text-left md:text-4xl font-semibold text-xl mb-5' >We hired people who are very passionate about what they do</h3>
