...
export default function Career() {
  return (
    <div className='bg-[#f0f0f0] text-[#131313] py-8 px-10 2xl:px-96 leading-loose lg:px-28'>
        ...
        <h1 className='text-4xl md:text-5xl font-bold'>Current Openings</h1>
          ...
          We are eager to learn more about your motivations for collaboration and the value you can bring to our projects.”</p>
    </div>
  )
}
